%% This script tries to calculate the effect of the filters associated with
%% the absorption profile of a wall. Try to relate the absorption coefficient 
%% of a band to the energy that the simulator actually absorbs (or reflects)
...
for BF=1:9
    ...
    %% configureHybrid (connectionToISM, receiver, osc_listener,       2,              200,        1,       1,       true);
