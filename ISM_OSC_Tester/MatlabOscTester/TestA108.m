...
adjustRoomParam = '\A108 Omni'; %'\Adj A108-C80-1pp-7Bands'; %Adj A108-EEY-1pp-7Bands; '\AbsorEyring\A108'; '\A108 Omni'
%% ------------------
DirectPath=true;
AttenuationReverb =true;
roomFile = 'A108_room_Ini.xml';
dp_Tmix = 8.2; %1, 20, 28, 40,  8.2;
RefOrdEff = 1;
%% -------------------
...
nameFileHyb = sprintf(formatFileHyb, RefOrd, floor(dp_Tmix), W_Slope)+'HYB.wav';
if RefOrd == 0 
    formatFileHyb = "wIrRO%iDP%02iW%02i";
    nameFileHyb = sprintf(formatFileHyb, RefOrd, floor(dp_Tmix), W_Slope)+'.wav';
end 
...
nameFileISM = sprintf(formatFileISM, RefOrd, floor(dp_Tmix), W_Slope)+'.wav';
...
nameFileWin = sprintf(formatFileWin, floor(dp_Tmix), W_Slope)+'.wav';
formatFileHyb= "tIrRO%iDP%02iW%02i";
nameFileHyb = sprintf(formatFileHyb, RefOrd, floor(dp_Tmix), W_Slope)+'HYB.wav';
if RefOrd == 0 
    formatFileHyb = "wIrRO%iDP%02iW%02i";
