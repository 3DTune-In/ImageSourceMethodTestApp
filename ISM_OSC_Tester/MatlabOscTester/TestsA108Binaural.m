...
%% corresponding to the four measurement points in room 'Aula 108' (A108)
...
%% ------------------
pS=1;
posS = [-0.45   2.02   -0.68;      %1
        -2.45   0.02   -0.68;      %2
         1.55   0.02   -0.68;      %3
        -0.45  -1.98   -0.68;];    %4
pL=1;                        
posL = [-0.45  0.02 -0.68];  %5
%% HRTF Omni
...
% folderAbsor = 'C:\Repos\of_v0.12.0_vs_release\ImageSourceMethodTestApp\bin\data\resources\workFolder\5';
%% Absor Eyring
