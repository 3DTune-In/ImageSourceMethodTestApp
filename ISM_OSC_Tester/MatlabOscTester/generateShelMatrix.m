...
[b0,b1,b2,a0,a1,a2] = calculateShelCoef.LowP (Fs, F0*sqrt(2), Qs, G);
a(1,:)= [a0, a1, a2];
b(1,:)= [b0, b1, b2];
...
for i=2:NF-1
    ...
    [b0,b1,b2,a0,a1,a2] = calculateShelCoef.BandP_Valimak (Fs, Fc, Qbp, G);
    a(i,:)= [a0, a1, a2];
    b(i,:)= [b0, b1, b2];
...
[b0,b1,b2,a0,a1, a2] = calculateShelCoef.HighP (Fs, Fc/sqrt(2), Qs, G);
a(NF,:)= [a0, a1, a2];
b(NF,:)= [b0, b1, b2];
